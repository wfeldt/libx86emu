...
static void x86emuOp_op_A_byte_AL_IMM(u8 op1)
{
  ...
  val = fetch_byte();
  DECODE_HEX2(val);
  emu->x86.R_AL = (*op_A_byte[type])(emu->x86.R_AL, val);
}
...
static void x86emuOp_op_A_word_AX_IMM(u8 op1)
{
  ...
  if(MODE_DATA32) {
    ...
    val = fetch_long();
    DECODE_HEX8(val);
    emu->x86.R_EAX = (*op_A_long[type])(emu->x86.R_EAX, val);
  }
  else {
    OP_DECODE("ax,");
    val = fetch_word();
    DECODE_HEX4(val);
    emu->x86.R_AX = (*op_A_word[type])(emu->x86.R_AX, val);
  }
}
...
static void x86emuOp_push_ES(u8 op1)
{
  ...
  if(MODE_DATA32) {
    push_long(emu->x86.R_ES);
  }
  else {
    push_word(emu->x86.R_ES);
  }
}
...
{
  OP_DECODE("pop es");
  x86emu_set_seg_register(emu, emu->x86.R_ES_SEL, MODE_DATA32 ? pop_long() : pop_word());
}
...
static void x86emuOp_push_CS(u8 op1)
{
  OP_DECODE("push cs");
  if(MODE_DATA32) {
    push_long(emu->x86.R_CS);
  }
  else {
    push_word(emu->x86.R_CS);
  }
}
...
static void x86emuOp_push_SS(u8 op1)
{
  ...
  if(MODE_DATA32) {
    push_long(emu->x86.R_SS);
  }
  else {
    push_word(emu->x86.R_SS);
  }
}
...
{
  OP_DECODE("pop ss");
  x86emu_set_seg_register(emu, emu->x86.R_SS_SEL, MODE_DATA32 ? pop_long() : pop_word());
}
...
static void x86emuOp_push_DS(u8 op1)
{
  ...
  if(MODE_DATA32) {
    push_long(emu->x86.R_DS);
  }
  else {
    push_word(emu->x86.R_DS);
  }
}
...
{
  OP_DECODE("pop ds");
  x86emu_set_seg_register(emu, emu->x86.R_DS_SEL, MODE_DATA32 ? pop_long() : pop_word());
}
...
{
  OP_DECODE("daa");
  emu->x86.R_AL = daa_byte(emu->x86.R_AL);
}
...
{
  OP_DECODE("das");
  emu->x86.R_AL = das_byte(emu->x86.R_AL);
}
...
{
  OP_DECODE("aaa");
  emu->x86.R_AX = aaa_word(emu->x86.R_AX);
}
...
{
  OP_DECODE("aas");
  emu->x86.R_AX = aas_word(emu->x86.R_AX);
}
...
static void x86emuOp_inc_AX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("inc eax");
    emu->x86.R_EAX = inc_long(emu->x86.R_EAX);
  }
  else {
    OP_DECODE("inc ax");
    emu->x86.R_AX = inc_word(emu->x86.R_AX);
  }
}
...
static void x86emuOp_inc_CX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("inc ecx");
    emu->x86.R_ECX = inc_long(emu->x86.R_ECX);
  }
  else {
    OP_DECODE("inc cx");
    emu->x86.R_CX = inc_word(emu->x86.R_CX);
  }
}
...
static void x86emuOp_inc_DX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("inc edx");
    emu->x86.R_EDX = inc_long(emu->x86.R_EDX);
  }
  else {
    OP_DECODE("inc dx");
    emu->x86.R_DX = inc_word(emu->x86.R_DX);
  }
}
...
static void x86emuOp_inc_BX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("inc ebx");
    emu->x86.R_EBX = inc_long(emu->x86.R_EBX);
  }
  else {
    OP_DECODE("inc bx");
    emu->x86.R_BX = inc_word(emu->x86.R_BX);
  }
}
...
static void x86emuOp_inc_SP(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("inc esp");
    emu->x86.R_ESP = inc_long(emu->x86.R_ESP);
  }
  else {
    OP_DECODE("inc sp");
    emu->x86.R_SP = inc_word(emu->x86.R_SP);
  }
}
...
static void x86emuOp_inc_BP(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("inc ebp");
    emu->x86.R_EBP = inc_long(emu->x86.R_EBP);
  }
  else {
    OP_DECODE("inc bp");
    emu->x86.R_BP = inc_word(emu->x86.R_BP);
  }
}
...
static void x86emuOp_inc_SI(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("inc esi");
    emu->x86.R_ESI = inc_long(emu->x86.R_ESI);
  }
  else {
    OP_DECODE("inc si");
    emu->x86.R_SI = inc_word(emu->x86.R_SI);
  }
}
...
static void x86emuOp_inc_DI(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("inc edi");
    emu->x86.R_EDI = inc_long(emu->x86.R_EDI);
  }
  else {
    OP_DECODE("inc di");
    emu->x86.R_DI = inc_word(emu->x86.R_DI);
  }
}
...
static void x86emuOp_dec_AX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("dec eax");
    emu->x86.R_EAX = dec_long(emu->x86.R_EAX);
  }
  else {
    OP_DECODE("dec ax");
    emu->x86.R_AX = dec_word(emu->x86.R_AX);
  }
}
...
static void x86emuOp_dec_CX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("dec ecx");
    emu->x86.R_ECX = dec_long(emu->x86.R_ECX);
  }
  else {
    OP_DECODE("dec cx");
    emu->x86.R_CX = dec_word(emu->x86.R_CX);
  }
}
...
static void x86emuOp_dec_DX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("dec edx");
    emu->x86.R_EDX = dec_long(emu->x86.R_EDX);
  }
  else {
    OP_DECODE("dec dx");
    emu->x86.R_DX = dec_word(emu->x86.R_DX);
  }
}
...
static void x86emuOp_dec_BX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("dec ebx");
    emu->x86.R_EBX = dec_long(emu->x86.R_EBX);
  }
  else {
    OP_DECODE("dec bx");
    emu->x86.R_BX = dec_word(emu->x86.R_BX);
  }
}
...
static void x86emuOp_dec_SP(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("dec esp");
    emu->x86.R_ESP = dec_long(emu->x86.R_ESP);
  }
  else {
    OP_DECODE("dec sp");
    emu->x86.R_SP = dec_word(emu->x86.R_SP);
  }
}
...
static void x86emuOp_dec_BP(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("dec ebp");
    emu->x86.R_EBP = dec_long(emu->x86.R_EBP);
  }
  else {
    OP_DECODE("dec bp");
    emu->x86.R_BP = dec_word(emu->x86.R_BP);
  }
}
...
static void x86emuOp_dec_SI(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("dec esi");
    emu->x86.R_ESI = dec_long(emu->x86.R_ESI);
  }
  else {
    OP_DECODE("dec si");
    emu->x86.R_SI = dec_word(emu->x86.R_SI);
  }
}
...
static void x86emuOp_dec_DI(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("dec edi");
    emu->x86.R_EDI = dec_long(emu->x86.R_EDI);
  }
  else {
    OP_DECODE("dec di");
    emu->x86.R_DI = dec_word(emu->x86.R_DI);
  }
}
...
static void x86emuOp_push_AX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("push eax");
    push_long(emu->x86.R_EAX);
  }
  else {
    OP_DECODE("push ax");
    push_word(emu->x86.R_AX);
  }
}
...
static void x86emuOp_push_CX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("push ecx");
    push_long(emu->x86.R_ECX);
  }
  else {
    OP_DECODE("push cx");
    push_word(emu->x86.R_CX);
  }
}
...
static void x86emuOp_push_DX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("push edx");
    push_long(emu->x86.R_EDX);
  }
  else {
    OP_DECODE("push dx");
    push_word(emu->x86.R_DX);
  }
}
...
static void x86emuOp_push_BX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("push ebx");
    push_long(emu->x86.R_EBX);
  }
  else {
    OP_DECODE("push bx");
    push_word(emu->x86.R_BX);
  }
}
...
static void x86emuOp_push_SP(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("push esp");
    push_long(emu->x86.R_ESP);
  }
  else {
    OP_DECODE("push sp");
    push_word(emu->x86.R_SP);
  }
}
...
static void x86emuOp_push_BP(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("push ebp");
    push_long(emu->x86.R_EBP);
  }
  else {
    OP_DECODE("push bp");
    push_word(emu->x86.R_BP);
  }
}
...
static void x86emuOp_push_SI(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("push esi");
    push_long(emu->x86.R_ESI);
  }
  else {
    OP_DECODE("push si");
    push_word(emu->x86.R_SI);
  }
}
...
static void x86emuOp_push_DI(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("push edi");
    push_long(emu->x86.R_EDI);
  }
  else {
    OP_DECODE("push di");
    push_word(emu->x86.R_DI);
  }
}
...
static void x86emuOp_pop_AX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("pop eax");
    emu->x86.R_EAX = pop_long();
  }
  else {
    OP_DECODE("pop ax");
    emu->x86.R_AX = pop_word();
  }
}
...
static void x86emuOp_pop_CX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("pop ecx");
    emu->x86.R_ECX = pop_long();
  }
  else {
    OP_DECODE("pop cx");
    emu->x86.R_CX = pop_word();
  }
}
...
static void x86emuOp_pop_DX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("pop edx");
    emu->x86.R_EDX = pop_long();
  }
  else {
    OP_DECODE("pop dx");
    emu->x86.R_DX = pop_word();
  }
}
...
static void x86emuOp_pop_BX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("pop ebx");
    emu->x86.R_EBX = pop_long();
  }
  else {
    OP_DECODE("pop bx");
    emu->x86.R_BX = pop_word();
  }
}
...
static void x86emuOp_pop_SP(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("pop esp");
    emu->x86.R_ESP = pop_long();
  }
  else {
    OP_DECODE("pop sp");
    emu->x86.R_SP = pop_word();
  }
}
...
static void x86emuOp_pop_BP(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("pop ebp");
    emu->x86.R_EBP = pop_long();
  }
  else {
    OP_DECODE("pop bp");
    emu->x86.R_BP = pop_word();
  }
}
...
static void x86emuOp_pop_DI(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("pop edi");
    emu->x86.R_EDI = pop_long();
  }
  else {
    OP_DECODE("pop di");
    emu->x86.R_DI = pop_word();
  }
}
...
static void x86emuOp_call_far_IMM(u8 op1)
{
  ...
  if(MODE_DATA32) {
    ...
    push_long(emu->x86.R_CS);
    push_long(emu->x86.R_EIP);
  }
  else {
    DECODE_HEX4(eip);

    push_word(emu->x86.R_CS);
    push_word(emu->x86.R_IP);
  }
...
static void x86emuOp_popf_word(u8 op1)
{
  if(MODE_DATA32) {
    ...
    emu->x86.R_EFLG = pop_long() | F_ALWAYS_ON;
  }
  else {
    OP_DECODE("popf");

    emu->x86.R_FLG = pop_word() | F_ALWAYS_ON;
  }
}
...
static void x86emuOp_mov_AL_M_IMM(u8 op1)
{
  ...
  emu->x86.R_AL = fetch_data_byte(addr);
}
...
static void x86emuOp_mov_AX_M_IMM(u8 op1)
{
  ...
  if(MODE_DATA32) {
    emu->x86.R_EAX = fetch_data_long(addr);
  }
  else {
    emu->x86.R_AX = fetch_data_word(addr);
  }
}
...
static void x86emuOp_movs_byte(u8 op1)
{
  ...
  if(MODE_ADDR32) {
    ...
    while(count--) {
      val = fetch_data_byte(emu->x86.R_ESI);
    ...
    while(count--) {
      val = fetch_data_byte(emu->x86.R_SI);
...
static void x86emuOp_movs_word(u8 op1)
{
  ...
  if(MODE_ADDR32) {
    ...
    while(count--) {
      if(MODE_DATA32) {
        val = fetch_data_long(emu->x86.R_ESI);
        store_data_long_abs(emu->x86.seg + R_ES_INDEX, emu->x86.R_EDI, val);
      }
      else {
        val = fetch_data_word(emu->x86.R_ESI);
    ...
    while(count--) {
      if(MODE_DATA32) {
        val = fetch_data_long(emu->x86.R_SI);
        store_data_long_abs(emu->x86.seg + R_ES_INDEX, emu->x86.R_DI, val);
      }
      else {
        val = fetch_data_word(emu->x86.R_SI);
...
static void x86emuOp_cmps_byte(u8 op1)
{
  ...
  if(MODE_ADDR32) {
    ...
    if(MODE_REP) {
      while(emu->x86.R_ECX) {
        val1 = fetch_data_byte(emu->x86.R_ESI);
        val2 = fetch_data_byte_abs(emu->x86.seg + R_ES_INDEX, emu->x86.R_EDI);
        cmp_byte(val1, val2);
        emu->x86.R_ECX--;
        emu->x86.R_ESI += inc;
        emu->x86.R_EDI += inc;
    ...
    if(MODE_REP) {
      while(emu->x86.R_CX) {
        val1 = fetch_data_byte(emu->x86.R_SI);
        val2 = fetch_data_byte_abs(emu->x86.seg + R_ES_INDEX, emu->x86.R_DI);
        cmp_byte(val1, val2);
        emu->x86.R_CX--;
        emu->x86.R_SI += inc;
        emu->x86.R_DI += inc;
...
static void x86emuOp_cmps_word(u8 op1)
{
  ...
  if(MODE_ADDR32) {
    if(MODE_REP) {
      while(emu->x86.R_ECX) {
        if(MODE_DATA32) {
          val1 = fetch_data_long(emu->x86.R_ESI);
          val2 = fetch_data_long_abs(emu->x86.seg + R_ES_INDEX, emu->x86.R_EDI);
          cmp_long(val1, val2);
        }
        else {
          val1 = fetch_data_word(emu->x86.R_ESI);
          val2 = fetch_data_word_abs(emu->x86.seg + R_ES_INDEX, emu->x86.R_EDI);
          cmp_word(val1, val2);
        }
        emu->x86.R_ECX--;
        emu->x86.R_ESI += inc;
    ...
    if(MODE_REP) {
      while(emu->x86.R_CX) {
        if(MODE_DATA32) {
          val1 = fetch_data_long(emu->x86.R_SI);
          val2 = fetch_data_long_abs(emu->x86.seg + R_ES_INDEX, emu->x86.R_DI);
          cmp_long(val1, val2);
        }
        else {
          val1 = fetch_data_word(emu->x86.R_SI);
          val2 = fetch_data_word_abs(emu->x86.seg + R_ES_INDEX, emu->x86.R_DI);
          cmp_word(val1, val2);
        }
        emu->x86.R_CX--;
        emu->x86.R_SI += inc;
...
static void x86emuOp_test_AX_IMM(u8 op1)
{
  ...
  if(MODE_DATA32) {
    ...
    imm = fetch_long();
    DECODE_HEX8(imm);
    test_long(emu->x86.R_EAX, imm);
  }
  else {
    OP_DECODE("test ax,");
    imm = fetch_word();
    DECODE_HEX4(imm);
    test_word(emu->x86.R_AX, imm);
  }
}
...
static void x86emuOp_lods_byte(u8 op1)
{
  ...
  if(MODE_ADDR32) {
    ...
    while(count--) {
      emu->x86.R_AL = fetch_data_byte(emu->x86.R_ESI);
      emu->x86.R_ESI += inc;
    }
  }
  else {
    ...
    while(count--) {
      emu->x86.R_AL = fetch_data_byte(emu->x86.R_SI);
      emu->x86.R_SI += inc;
    }
  }
}
...
static void x86emuOp_lods_word(u8 op1)
{
  ...
  if(MODE_ADDR32) {
    ...
    while(count--) {
      if(MODE_DATA32) {
        emu->x86.R_EAX = fetch_data_long(emu->x86.R_ESI);
      }
      else {
        emu->x86.R_AX = fetch_data_word(emu->x86.R_ESI);
      }
      emu->x86.R_ESI += inc;
    }
  }
    ...
    while(count--) {
      if(MODE_DATA32) {
        emu->x86.R_EAX = fetch_data_long(emu->x86.R_SI);
      }
      else {
        emu->x86.R_AX = fetch_data_word(emu->x86.R_SI);
      }
      emu->x86.R_SI += inc;
    }
  }
...
static void x86emuOp_scas_byte(u8 op1)
{
  ...
  if(MODE_ADDR32) {
    ...
    if(MODE_REP) {
      while(emu->x86.R_ECX) {
        val = fetch_data_byte_abs(emu->x86.seg + R_ES_INDEX, emu->x86.R_EDI);
        cmp_byte(emu->x86.R_AL, val);
        emu->x86.R_ECX--;
        emu->x86.R_EDI += inc;
        if(eval_condition(cond)) break;
      }
    ...
    if(MODE_REP) {
      while(emu->x86.R_CX) {
        val = fetch_data_byte_abs(emu->x86.seg + R_ES_INDEX, emu->x86.R_DI);
        cmp_byte(emu->x86.R_AL, val);
        emu->x86.R_CX--;
        emu->x86.R_DI += inc;
        if(eval_condition(cond)) break;
...
static void x86emuOp_scas_word(u8 op1)
{
  ...
  if(MODE_ADDR32) {
    if(MODE_REP) {
      while(emu->x86.R_ECX) {
        if(MODE_DATA32) {
          val = fetch_data_long_abs(emu->x86.seg + R_ES_INDEX, emu->x86.R_EDI);
          cmp_long(emu->x86.R_EAX, val);
        }
        else {
          val = fetch_data_word_abs(emu->x86.seg + R_ES_INDEX, emu->x86.R_EDI);
          cmp_word(emu->x86.R_AX, val);
        }
        emu->x86.R_ECX--;
        emu->x86.R_EDI += inc;
        if(eval_condition(cond)) break;
    ...
    if(MODE_REP) {
      while(emu->x86.R_CX) {
        if(MODE_DATA32) {
          val = fetch_data_long_abs(emu->x86.seg + R_ES_INDEX, emu->x86.R_DI);
          cmp_long(emu->x86.R_EAX, val);
        }
        else {
          val = fetch_data_word_abs(emu->x86.seg + R_ES_INDEX, emu->x86.R_DI);
          cmp_word(emu->x86.R_AX, val);
        }
        emu->x86.R_CX--;
        emu->x86.R_DI += inc;
...
static void x86emuOp_ret_near_IMM(u8 op1)
{
  ...
  if(MODE_DATA32) {
    emu->x86.R_EIP = pop_long();
    emu->x86.R_ESP += imm;
  }
  else {
    emu->x86.R_EIP = pop_word();
    emu->x86.R_SP += imm;
  }
}
...
static void x86emuOp_les_R_IMM(u8 op1)
{
  ...
  if(mod == 3) {
    ...
    x86emu_set_seg_register(emu, emu->x86.R_ES_SEL, fetch_data_word(addr));
  }
}
...
static void x86emuOp_lds_R_IMM(u8 op1)
{
  ...
  if(mod == 3) {
    ...
    x86emu_set_seg_register(emu, emu->x86.R_DS_SEL, fetch_data_word(addr));
  }
}
  ...
  if(nesting > 0) {
    if(MODE_DATA32) {
      for(i = 1; i < nesting; i++) {
        if(MODE_STACK32) {
          emu->x86.R_EBP -= 4;
          push_long(fetch_data_long_abs(emu->x86.seg + R_SS_INDEX, emu->x86.R_EBP));
        }
        else {
          emu->x86.R_BP -= 4;
          push_long(fetch_data_long_abs(emu->x86.seg + R_SS_INDEX, emu->x86.R_BP));
        }
      }
    }
    else {
      for(i = 1; i < nesting; i++) {
        if(MODE_STACK32) {
          emu->x86.R_EBP -= 2;
          push_word(fetch_data_word_abs(emu->x86.seg + R_SS_INDEX, emu->x86.R_EBP));
        }
        else {
          emu->x86.R_BP -= 2;
          push_word(fetch_data_word_abs(emu->x86.seg + R_SS_INDEX, emu->x86.R_BP));
        }
      }
    }
...
static void x86emuOp_aam(u8 op1)
{
  ...
  emu->x86.R_AX = aam_word(emu->x86.R_AL, base);
}
...
static void x86emuOp_aad(u8 op1)
{
  ...
  emu->x86.R_AX = aad_word(emu->x86.R_AX, base);
}
...
static void x86emuOp_in_byte_AL_IMM(u8 op1)
{
  ...
  emu->x86.R_AL = fetch_io_byte(port);
}
...
static void x86emuOp_in_word_AX_IMM(u8 op1)
{
  ...
  if(MODE_DATA32) {
    OP_DECODE("eax,");
    emu->x86.R_EAX = fetch_io_long(port);
  } else {
    OP_DECODE("ax,");
    emu->x86.R_AX = fetch_io_word(port);
  }
...
{
  OP_DECODE("in al,dx");
  emu->x86.R_AL = fetch_io_byte(emu->x86.R_DX);
}
...
static void x86emuOp_in_word_AX_DX(u8 op1)
{
  if(MODE_DATA32) {
    OP_DECODE("in eax,dx");
    emu->x86.R_EAX = fetch_io_long(emu->x86.R_DX);
  }
  else {
    OP_DECODE("in ax,dx");
    emu->x86.R_AX = fetch_io_word(emu->x86.R_DX);
  }
}
